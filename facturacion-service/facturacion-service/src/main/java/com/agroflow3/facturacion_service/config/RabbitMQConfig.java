...
public class RabbitMQConfig {
    ...
    // Cola para recibir cosechas que necesitan facturación
    @Bean
    public Queue colaFacturacion() {
        return new Queue(QUEUE_FACTURACION, true);
    }

    // Cola para enviar facturas completadas de vuelta a cosecha service
    @Bean
    public Queue colaFacturacionCompletada() {
        return new Queue(QUEUE_FACTURACION_COMPLETADA, true);
    }

    // Binding para recibir cosechas que necesitan facturación
    @Bean
    ...
    // Binding para enviar facturas completadas
    @Bean
